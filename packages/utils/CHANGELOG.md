...
- [`67353f01`](https://github.com/kurrent-io/Design-System/commit/67353f01eacc7e1ec0839c6919749024198cd0e8) - Fix operator precedence in the focusable element sort comparator. The previous expression compared elements by the first element's `tabIndex` alone, making the sort order unspecified when elements with differing `tabIndex` values were present.
